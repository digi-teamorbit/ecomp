...
Route::get('/business-insurance','HomeController@businessInsurance')->name('business_insurance');
Route::get('/business-insurance/{business}','HomeController@businessInsuranceDetails')->name('business_insurance_details');
Route::get('/channel-partners','HomeController@channelPartners')->name('channel_partners');
Route::get('/contact','HomeController@contact')->name('contact');
Route::get('/education','HomeController@education')->name('education');
Route::get('/education/{education}','HomeController@educationDetails')->name('education_details');
Route::get('/faq','HomeController@faq')->name('faq');
Route::get('/login-page','HomeController@login')->name('login_page');
Route::get('/newsfeed','HomeController@newsfeed')->name('newsfeed');
Route::get('/newsfeed/{newsfeed}','HomeController@newsfeedDetails')->name('newsfeed_details');
Route::get('/partner-benefits','HomeController@partnerBenefits')->name('partner_benefits');
Route::get('/partner-integration','HomeController@partnerIntegration')->name('partner_integration');
Route::get('/partner','HomeController@partner')->name('partner');
Route::get('/policies-disclosures','HomeController@policiesDisclosures')->name('policies_disclosures');
Route::get('/service-center','HomeController@serviceCenter')->name('service_center');
Route::post('partner-submit','HomeController@partnerSubmit')->name('partnerSubmit');
...
Route::resource('admin/business-insurance', 'Admin\\BusinessInsuranceController');
Route::resource('admin/channel-partner', 'Admin\\ChannelPartnerController');
